...
public class Airplanes
{
	public static void main(String[] args)
	{
		...
		airport.getTerminals().forEach(terminal -> terminal.getFlights().stream().filter(f ->
				f.getType().equals(Flight.Type.DEPARTURE) && f.getDate().before(before) && f.getDate().after(now))
				.forEach(flight ->
