package module02.star.IncomeCalculator;
...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        double minIncome=(minInvestmentsAmount/(1.0-mainTaxPercent)+calculateFixedCharges())/(1.0-managerPercent);
        System.out.printf("Минимальный доход для возможности инвестировать: %.0f\n",Math.ceil(minIncome));
